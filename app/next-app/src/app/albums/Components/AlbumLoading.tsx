...
const AlbumLoading = ({ artist, name, rating, year }: Props) => (
  ...
  >
    ...
    <div
      className="
        flex justify-start items-center  h-full whitespace-nowrap text-ellipsis
        overflow-hidden text-xl bottom-0 flex-row
      "
    >
      ...
      <div className="overflow-hidden max-width-full">
        <div
          className="
            overflow-hidden whitespace-nowrap text-ellipsis max-w-full text-lg 
            font-bold
          "
        >
          {artist.name}
        ...
        <div
          className="overflow-hidden text-ellipsis text-sm text-gray font-bold"
        >
          {year ?? "N/A"}
        </div>
      </div>
